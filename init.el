...
(require 'package)
(defvar package-list)
(setq package-list '(auto-complete magit jump inflections findr ruby-mode web-mode yaml-mode flycheck feature-mode markdown-mode json-mode go-mode go-autocomplete jedi dockerfile-mode clojure-mode cider tuareg merlin flycheck-ocaml terraform-mode solidity-mode))
